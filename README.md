...
# 🌊 Smart System for Seaweed Cultivation & Harvest Management 🌱

Empowering Sri Lankan seaweed farmers with **AI, IoT,** and **predictive analytics**.  
Automate species identification, monitor environments, predict harvest readiness, and add value through traceable post-harvest management.
...
<p align="center">
  <img src="assets/architecture-diagram.png" width="80%" alt="Integrated Smart Seaweed Farming System Architecture"/>
</p>
...
- 🌡️ Monitors temp, pH, salinity & light via IoT
...
- 🛡️ _First all-in-one traceable post-harvest tool!_
